...
def run_multihead_self_attention(
    ...
    m.q_proj.weight.data = q_proj_weight
    m.k_proj.weight.data = k_proj_weight
    m.v_proj.weight.data = v_proj_weight
    m.output_proj.weight.data = o_proj_weight
    return m(in_features)
...
def run_rope(
    ...
    m = RotaryPositionalEmbedding(theta, d_k, max_seq_len, device=in_query_or_key.device)
